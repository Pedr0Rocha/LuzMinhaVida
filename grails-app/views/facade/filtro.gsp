                ...
                <div id = 'overall'>
                    <g:form controller="Produtos" action="filtro">
                        ...
                        <label for="Categoria">
                            ...
                            <g:select id="categoria" name="categoria.id" from="${luzminhavida.CategoriaProdutos.list()}" optionKey="id" optionValue="name" required="" value="${produtosInstance?.categoria?.name}" class="many-to-one" noSelection="['null':'Todos']"/>
                        </label>
