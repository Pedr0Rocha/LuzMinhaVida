    ...
    <body>
        ...
        <div class="nav" role="navigation">
            <ul>
                ...
                <li><g:link class="search" controller="produtos" action="search"><g:message code="default.search.label" args="[entityName]" /></g:link></li>
                </ul>
            </div>
                    ...
                    <tbody>
                        <g:each in="${categoriaInstance}" status="i" var="produtosInstance">
                            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                                ...
                                <td><g:link controller="produtos" action="show" id="${produtosInstance.id}">${fieldValue(bean: produtosInstance, field: "nomeProduto")}</g:link></td>
