		...
		<div id="list-produtos" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="categoria" title="${message(code: 'produtos.categoria.label', default: 'Categoria')}" />
				...
				<g:each in="${produtosInstanceList}" status="i" var="produtosInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: produtosInstance, field: "categoria")}</td>
